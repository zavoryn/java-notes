...
> **中文总结**: 提出"上下文工程"概念，认为比传统提示工程更重要。涵盖上下文压缩、结构化笔记、子 Agent 架构、即时检索等策略。核心观点：上下文窗口是 Agent 最宝贵的资源，需像管理内存一样精心管理。

> Source: https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents
> Authors: Anthropic's Applied AI team: Prithvi Rajasekaran, Ethan Dixon, Carly Ryan, and Jeremy Hadfield
